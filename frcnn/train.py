...
def main(args):
    ...
    TRAIN_DIR_IMAGES = os.getcwd()+os.path.normpath(data_configs['TRAIN_DIR_IMAGES'])
    TRAIN_DIR_LABELS = os.getcwd()+os.path.normpath(data_configs['TRAIN_DIR_LABELS'])
    VALID_DIR_IMAGES = os.getcwd()+os.path.normpath(data_configs['VALID_DIR_IMAGES'])
    VALID_DIR_LABELS = os.getcwd()+os.path.normpath(data_configs['VALID_DIR_LABELS'])
    # print("Caminho dos diretórios:", TRAIN_DIR_IMAGES, " ||", TRAIN_DIR_LABELS)
    ...
    for epoch in range(start_epochs, NUM_EPOCHS):
        ...
        #####################################
        Prec, Rec = evaluate_precision_recall(model, valid_loader, DEVICE)
        ...
        #precision, recall = evaluate_model(model, train_loader, DEVICE)
