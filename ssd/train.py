...
def create_output_folder():
    ...
    new_folder = os.path.join(base_dir, f"output_{new_id}")
...
print("Saving training results in:", output_dir)
...
if __name__ == '__main__':
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        save_best_model(
            model, float(metric_summary['map']), epoch, output_dir
        )
